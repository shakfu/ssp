...
PluginEditor::PluginEditor(PluginProcessor& p) : base_type(&p, MAX_VIEW), processor_(p) {
    ...
    addParamPage(std::make_shared<pcontrol_type>(processor_.params_.pitch, 1.0f, 0.01),
                 std::make_shared<pcontrol_type>(processor_.params_.first, 1.0f, 1.0f), nullptr, nullptr, view,
                 Colours::orange);
    addParamPage(std::make_shared<pcontrol_type>(processor_.params_.centre, 1.0f, 0.1f),
                 std::make_shared<pcontrol_type>(processor_.params_.spread, 1.0f, 0.1f),
                 std::make_shared<pcontrol_type>(processor_.params_.amount, 0.1, 0.01f), nullptr, view,
                 Colours::orange);
    ...
    unsigned h = 0;
    addParamPage(std::make_shared<pcontrol_type>(processor_.getHarmonic(0).amp, 0.25),
                 ...
                 std::make_shared<pcontrol_type>(processor_.getHarmonic(3).amp, 0.25), view, clrs[view % L_CLRS]);

    addParamPage(std::make_shared<pcontrol_type>(processor_.getHarmonic(4).amp, 0.25),
                 ...
                 std::make_shared<pcontrol_type>(processor_.getHarmonic(7).amp, 0.25), view, clrs[view % L_CLRS]);
    addParamPage(std::make_shared<pcontrol_type>(processor_.getHarmonic(8).amp, 0.25),
                 ...
                 std::make_shared<pcontrol_type>(processor_.getHarmonic(11).amp, 0.25), view, clrs[view % L_CLRS]);
    addParamPage(std::make_shared<pcontrol_type>(processor_.getHarmonic(12).amp, 0.25),
                 ...
                 std::make_shared<pcontrol_type>(processor_.getHarmonic(15).amp, 0.25), view, clrs[view % L_CLRS]);
