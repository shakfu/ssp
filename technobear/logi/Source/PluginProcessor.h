...
private:
    enum OperType { OT_AND, OT_OR, OT_XOR, OT_NAND, OT_NOR, OT_NOT_A, OT_NOT_B, OT_GT, OT_LT, OT_MAX };
    ...
    float lastIn_[I_MAX] = { false, false, false, false, false, false, false, false };

    bool lastOut_[O_MAX] = { false, false, false, false, false };
