...
public:
    ...
    enum CvMode { CV_MODE_NONE, CV_MODE_ADD, CV_MODE_LOC, CV_MODE_SNAKE, CV_MODE_SH, CV_MODE_MAX };
    ...
    void getActiveData(unsigned& xp, unsigned& yp, unsigned& cp, float& xCv, float& yCv, float& cCv, bool& xGate,
                       bool& yGate, bool& cGate) const;
