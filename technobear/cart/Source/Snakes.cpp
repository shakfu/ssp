...
public:
    explicit ReneEnumSnake(const std::string& name, const unsigned* pattern) : name_(name), pattern_(pattern) {}

    const std::string& name() { return name_; }

    unsigned getPosition(unsigned seq_step) { return pattern_[seq_step]; }
...
public:
    ...
    unsigned getPosition(unsigned seq_step) { return seq_step; }
...
Snakes::Snakes() {
    static constexpr unsigned renepatterns[16][16] = { { // pattern 1
                                                       ...
                                                       { // pattern 4
                                                         0, 4, 8, 12, 12, 9, 5, 1, 2, 6, 10, 14, 15, 11, 7, 3
                                                       ...
                                                       { // pattern 7
                                                         0, 1, 4, 8, 5, 2, 3, 6, 9, 12, 13, 10, 7, 11, 14, 14 },
                                                       { // pattern 8
                                                         0, 5, 10, 15, 14, 9, 4, 1, 6, 11, 7, 2, 8, 13, 12, 3 },
                                                       { // pattern 9
                                                         0, 12, 13, 3, 2, 14, 15, 1, 7, 8, 9, 5, 4, 10, 11, 6 },
                                                       { // pattern 10
                                                         0, 7, 10, 14, 4, 1, 8, 11, 12, 5, 2, 9, 15, 13, 6, 4 },
                                                       {
                                                           // pattern 11
                                                           0,
                                                           1,
                                                       ...
                                                       { // pattern 12
                                                         0, 8, 1, 9, 6, 14, 7, 15, 4, 12, 5, 13, 2, 10, 3, 11 },
                                                       { // pattern 13
                                                         0, 1, 2, 3, 4, 5, 6, 7, 12, 14, 14, 15, 8, 9, 10, 11 },
                                                       { // pattern 14
                                                         0, 3, 11, 10, 2, 5, 12, 12, 4, 7, 15, 14, 6, 1, 9, 8 },
