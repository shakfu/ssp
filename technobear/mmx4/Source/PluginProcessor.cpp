...
PluginProcessor::PluginParams::PluginParams(AudioProcessorValueTreeState& apvt)
    : vca{ (*apvt.getParameter(ID::vca_1a)), (*apvt.getParameter(ID::vca_1b)),
           (*apvt.getParameter(ID::vca_1c)), (*apvt.getParameter(ID::vca_1d)),

           (*apvt.getParameter(ID::vca_2a)), (*apvt.getParameter(ID::vca_2b)),
           (*apvt.getParameter(ID::vca_2c)), (*apvt.getParameter(ID::vca_2d)),

           (*apvt.getParameter(ID::vca_3a)), (*apvt.getParameter(ID::vca_3b)),
           (*apvt.getParameter(ID::vca_3c)), (*apvt.getParameter(ID::vca_3d)),

           (*apvt.getParameter(ID::vca_4a)), (*apvt.getParameter(ID::vca_4b)),
           (*apvt.getParameter(ID::vca_4c)), (*apvt.getParameter(ID::vca_4d)) } {
}
        ...
        if (outEnabledL || outEnabledR) {
            for (unsigned in = 0; in < MAX_SIG_IN; in++) {
                ...
                if (vcaEnabled) {
                    ...
                    if (inEnabledL) { outBufs_.addFrom(outL, 0, buffer, inL, 0, n, vca); }
                    if (inEnabledR) { outBufs_.addFrom(outR, 0, buffer, inR, 0, n, vca); }
                }
            }
        } else {
            for (unsigned in = 0; in < MAX_SIG_IN; in++) { lastVcaCV_[in][out] = 0.0f; }
        }
    }
