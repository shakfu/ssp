...
public:
    explicit LayerView(PluginProcessor& p, unsigned lidx, Colour clr) : ssp::BarParamEditor(&p, false), processor_(p) {
        ...
        addButtonPage(std::make_shared<bcontrol_type>(layer->mode_, 24, Colours::red),
                      std::make_shared<bcontrol_type>(layer->loop_, 24, Colours::yellow), nullptr, nullptr, nullptr,
