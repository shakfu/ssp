...
public:
    ...
    void initSignal(unsigned sigN, const std::string& label, float* buf, unsigned bufn, unsigned n,
    ...
    void pos(unsigned sigN, unsigned pos) { pos_[sigN] = pos; }

    void signalVisible(unsigned sigN, bool v) { visible_[sigN] = v; }
...
private:
    juce_UseDebuggingNewOperator bool grid_ = false;
    bool legend_ = false;
