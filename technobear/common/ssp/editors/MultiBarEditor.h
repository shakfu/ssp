...
class MultiBarEditor : public MultiViewEditor {
public:
    explicit MultiBarEditor(BaseProcessor* p, unsigned maxView);

    ControlPage addParamPage(std::shared_ptr<BaseParamControl> c1, std::shared_ptr<BaseParamControl> c2,
                             std::shared_ptr<BaseParamControl> c3, std::shared_ptr<BaseParamControl> c4, unsigned view,
                             juce::Colour clr = Colours::red) override;
