...
SingleViewEditor::SingleViewEditor(BaseProcessor* p) : base_type(p) {
...
SingleViewEditor::ControlPage SingleViewEditor::addParamPage(std::shared_ptr<BaseParamControl> c1,
...
void SingleViewEditor::addButtonPage(std::shared_ptr<ParamButton> c1, std::shared_ptr<ParamButton> c2,
