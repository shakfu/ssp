...
PluginProcessor::ASParam::ASParam(AudioProcessorValueTreeState& apvt, StringRef drm)
    : DrumBaseParam(apvt, drm), AS_Snappy(*apvt.getParameter(getDrumPid(drm, ID::AS_Snappy))) {
}
...
PluginProcessor::HH1Param::HH1Param(AudioProcessorValueTreeState& apvt, StringRef drm)
    : DrumBaseParam(apvt, drm), HH1_Noise(*apvt.getParameter(getDrumPid(drm, ID::HH1_Noise))) {
}

PluginProcessor::HH2Param::HH2Param(AudioProcessorValueTreeState& apvt, StringRef drm)
    : DrumBaseParam(apvt, drm), HH2_Noise(*apvt.getParameter(getDrumPid(drm, ID::HH2_Noise))) {
}
...
AudioProcessorValueTreeState::ParameterLayout PluginProcessor::createParameterLayout() {
...

    {
        ...
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AB, ID::Accent), "AB Accent", 0, 1.0f, 0.1f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AB, ID::Freq), "AB Freq", 1, 440.0f, 55.f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AB, ID::Tone), "AB Tone", 0, 1.0f, 0.1f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AB, ID::Decay), "AB Decay", 0, 1.0f, 0.3f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AB, ID::Gain), "AB Gain", 0, 10.0f, 3.0f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AB, ID::AB_SelfFM), "AB Self FM", 0, 1.0f, 1.0f));
        drum->addChild(std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AB, ID::AB_AttackFM), "AB Attack FM", 0,
                                                                 1.0f, 0.5f));
    ...
    }
    {
        ...
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::Accent), "SB Accent", 0, 1.0f, 0.2f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::Freq), "SB Freq", 1, 440.0f, 55.f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::Tone), "SB Tone", 0, 1.0f, 0.6f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::Decay), "SB Decay", 0, 1.0f, 0.7f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::Gain), "SB Gain", 0, 10.0f, 1.5f));
        drum->addChild(std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::SB_FMDecay), "SB FM Decay", 0,
                                                                 1.0f, 0.3f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::SB_EnvFM), "SB FM Env", 0, 1.0f, 0.6f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SB, ID::SB_Dirt), "SB Dirt", 0, 1.0f, 0.7f));
        params.add(std::move(drum));
    }
    {
        ...
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AS, ID::Accent), "AS Accent", 0, 1.0f, 0.6f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AS, ID::Freq), "AS Freq", 1, 440.0f, 220.f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AS, ID::Tone), "AS Tone", 0, 1.0f, 0.5f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AS, ID::Decay), "AS Decay", 0, 1.0f, 0.3f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AS, ID::Gain), "AS Gain", 0, 10.0f, 1.0f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::AS, ID::AS_Snappy), "AS Snappy", 0, 1.0f, 0.7f));
        params.add(std::move(drum));
    }
    {
        ...
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SS, ID::Accent), "SS Accent", 0, 1.0f, 0.6f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SS, ID::Freq), "SS Freq", 1, 440.0f, 220.f));
        drum->addChild(std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SS, ID::Tone), "SS Tone", 0, 1.0f,
                                                                 0.5f));  // not on SS
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SS, ID::Decay), "SS Decay", 0, 1.0f, 0.3f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SS, ID::Gain), "SS Gain", 0, 10.0f, 1.0f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SS, ID::SS_Snappy), "SS Snappy", 0, 1.0f, 0.7f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::SS, ID::SS_FM), "SS FM", 0, 1.0f, 0.1f));
        params.add(std::move(drum));
    }

    {
        ...
        drum->addChild(
            std::make_unique<ssp::BaseBoolParameter>(getDrumPid(ID::HH1, ID::Sustain), "HH1 Sustain", false));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH1, ID::Accent), "HH1 Accent", 0, 1.0f, 0.8f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH1, ID::Freq), "HH1 Freq", 1, 5000.0f, 3000));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH1, ID::Tone), "HH1 Tone", 0, 1.0f, 0.5f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH1, ID::Decay), "HH1 Decay", 0, 1.0f, 0.4f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH1, ID::Gain), "HH1 Gain", 0, 10.0f, 2.0f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH1, ID::HH1_Noise), "HH1 Noise", 0, 1.0f, 0.8f));
        params.add(std::move(drum));
    }

    {
        ...
        drum->addChild(
            std::make_unique<ssp::BaseBoolParameter>(getDrumPid(ID::HH2, ID::Sustain), "HH2 Sustain", false));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH2, ID::Accent), "HH2 Accent", 0, 1.0f, 0.8f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH2, ID::Freq), "HH2 Freq", 1, 5000.0f, 3000));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH2, ID::Tone), "HH2 Tone", 0, 1.0f, 0.5f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH2, ID::Decay), "HH2 Decay", 0, 1.0f, 0.4f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH2, ID::Gain), "HH2 Gain", 0, 10.0f, 2.0f));
        drum->addChild(
            std::make_unique<ssp::BaseFloatParameter>(getDrumPid(ID::HH2, ID::HH2_Noise), "HH2 Noise", 0, 1.0f, 0.8f));
        params.add(std::move(drum));
    }
...
const String PluginProcessor::getInputBusName(int channelIndex) {
    static String inBusName[I_MAX] = { "AB Trig", "AB Accent", "SB Trig",  "SB Accent",  "AS Trig",  "AS Accent",
                                       "SS Trig", "SS Accent", "HH1 Trig", "HH1 Accent", "HH2 Trig", "HH2 Accent" };
...
const String PluginProcessor::getOutputBusName(int channelIndex) {
    static String outBusName[O_MAX] = { "A BD", "S BD", "A Snare", "S Snare", "Hi Hat 1", "Hi Hat 2" };
    ...
    for (unsigned s = 0; s < sz; s++) {
        if (isInputEnabled(I_AB_TRIG) && isOutputEnabled(O_AB)) {
            ...
            if (trig) {
                ...
                float accent = constrain(params_.ab_.Accent.getValue() + buffer.getSample(I_AB_ACCENT, s), 0.0f, 1.0f);
        ...
        if (isInputEnabled(I_SB_TRIG) && isOutputEnabled(O_SB)) {
            ...
            if (trig) {
                ...
                float accent = constrain(params_.sb_.Accent.getValue() + buffer.getSample(I_SB_ACCENT, s), 0.0f, 1.0f);
        ...
        if (isInputEnabled(I_AS_TRIG) && isOutputEnabled(O_AS)) {
            ...
            if (trig) {
                ...
                float accent = constrain(params_.as_.Accent.getValue() + buffer.getSample(I_AS_ACCENT, s), 0.0f, 1.0f);
        ...
        if (isInputEnabled(I_SS_TRIG) && isOutputEnabled(O_SS)) {
            ...
            if (trig) {
                ...
                float accent = constrain(params_.ss_.Accent.getValue() + buffer.getSample(I_SS_ACCENT, s), 0.0f, 1.0f);
        ...
        if (isInputEnabled(I_HH1_TRIG) && isOutputEnabled(O_HH1)) {
            ...
            if (trig) {
                ...
                float accent =
                    constrain(params_.hh1_.Accent.getValue() + buffer.getSample(I_HH1_ACCENT, s), 0.0f, 1.0f);
        ...
        if (isInputEnabled(I_HH2_TRIG) && isOutputEnabled(O_HH2)) {
            ...
            if (trig) {
                ...
                float accent =
                    constrain(params_.hh2_.Accent.getValue() + buffer.getSample(I_HH2_ACCENT, s), 0.0f, 1.0f);
