...
PluginEditor::PluginEditor(PluginProcessor& p) : base_type(&p, MAX_VIEW), processor_(p) {
    static juce::Colour clrs[L_CLRS] = { Colours::cyan,       Colours::lightcyan, Colours::green,
                                         Colours::lightgreen, Colours::blue,      Colours::lightblue };
    unsigned view;
    ...
    {  // AB
        ...
        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.ab_.Freq, 100, 1),
                     ...
                     std::make_shared<pcontrol_type>(processor_.params_.ab_.Accent, defCoarse, defFine), view,
                     clrs[view]);
    ...
    {  // SB
        ...
        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.sb_.Freq, 100, 1),
                     ...
                     nullptr, std::make_shared<pcontrol_type>(processor_.params_.sb_.Accent, defCoarse, defFine), view,
                     clrs[view]);

        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.sb_.Gain, 1.0f, 0.05f),
                     ...
                     std::make_shared<pcontrol_type>(processor_.params_.sb_.SB_EnvFM, defCoarse, defFine), view,
                     clrs[view]);
    }
    ...
    {  // AS
        ...
        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.as_.Freq, 100, 1),
                     ...
                     std::make_shared<pcontrol_type>(processor_.params_.as_.Accent, defCoarse, defFine), view,
                     clrs[view]);
    ...
    {  // SS
        ...
        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.ss_.Freq, 100, 1),
                     ...
                     nullptr, std::make_shared<pcontrol_type>(processor_.params_.ss_.Accent, defCoarse, defFine), view,
                     clrs[view]);

        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.ss_.Gain, 1.0f, 0.05f),
                     std::make_shared<pcontrol_type>(processor_.params_.ss_.SS_FM, defCoarse, defFine),
                     std::make_shared<pcontrol_type>(processor_.params_.ss_.SS_Snappy, defCoarse, defFine), nullptr,
                     view, clrs[view]);
    }
    {  // HH1
        view++;
        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.hh1_.Freq, 100, 1),
                     ...
                     std::make_shared<pcontrol_type>(processor_.params_.hh1_.Accent, defCoarse, defFine), view,
                     clrs[view]);
    ...
    {  // HH2
        ...
        addParamPage(std::make_shared<pcontrol_type>(processor_.params_.hh2_.Freq, 100, 1),
                     ...
                     std::make_shared<pcontrol_type>(processor_.params_.hh2_.Accent, defCoarse, defFine), view,
                     clrs[view]);
