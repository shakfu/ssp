...
std::shared_ptr<Algo> PluginProcessor::createAlgo(unsigned a) {
    switch (a) {
        ...
        case A_S_DELAY: return std::make_shared<AgSDelay>();
...
PluginProcessor::PluginProcessor(const AudioProcessor::BusesProperties& ioLayouts,
    ...
    for (auto e = 0; e < MAX_ENG; e++) { algo_[e] = createAlgo(A_DISPLAY); }
}
...
const String PluginProcessor::getInputBusName(int channelIndex) {
    static String inBusName[I_MAX] = { "X 1", "Y 1", "Z 1", "X 2", "Y 2", "Z 2",
...
const String PluginProcessor::getOutputBusName(int channelIndex) {
    static String outBusName[O_MAX] = { "A 1", "B 1", "A 2", "B 2", "A 3", "B 3", "A 4", "B 4" };
